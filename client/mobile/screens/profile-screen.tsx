      ...
      <ScrollView style={[styles.screen, { backgroundColor: palette.background }]} contentContainerStyle={styles.content}>
        <View style={styles.guestShell}>
          ...
          <View style={styles.guestActions}>
            <Pressable onPress={() => router.push('/auth?mode=login')} style={[styles.primaryAction, { backgroundColor: palette.tint }]}>
              <Text style={styles.primaryActionText}>Log in</Text>
            </Pressable>
            <Pressable onPress={() => router.push('/auth?mode=signup')} style={[styles.secondaryAction, { backgroundColor: palette.surface }]}>
...
const styles = StyleSheet.create({
  ...
  guestActions: { flexDirection: 'row', gap: 10, paddingTop: 8 },
